  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex flex-1 h-[calc(100vh-4rem)] overflow-hidden">
        ...
        {/* Main content */}
        <main className="flex-1 w-full h-full overflow-y-auto p-4 lg:p-8 pb-24">
          ...
          <div className="flex flex-col items-center mt-12">
            <img
              src="https://img.youtube.com/vi/qiSCMNBIP2g/0.jpg"
              alt="Python Intro Video Thumbnail"
              className="cursor-pointer rounded-lg shadow-lg max-w-full w-96 hover:brightness-90 transition"
...
//         {/* Fragment to group popup and main content */}
//         <>
//           {/* Main content */}
...
//       <img
//         src="https://img.youtube.com/vi/qiSCMNBIP2g/0.jpg"  // YouTube video thumbnail
//         alt="Python Intro Video Thumbnail"
//         className="cursor-pointer rounded-lg shadow-lg max-w-full w-96 hover:brightness-90 transition"
//         onClick={() => setIsOpen(true)}
//       />

//       {/* Optional: styled text button below the image */}
//       <button
//         onClick={() => setIsOpen(true)}
//         className="mt-4 text-purple-600 hover:text-purple-800 font-semibold"
//       >
